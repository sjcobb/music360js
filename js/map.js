...
function getInstrumentMappingTemplate(movement = 'physics') {
...
// getInstrumentMapping(value: number, providedUnits: string = 'ones') {
function getInstrumentMapping(index, obj) {
...
function getKeyboardMapping(input) {
    const instrumentMapping = getInstrumentMappingTemplate();
