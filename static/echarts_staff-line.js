 ...
 *** ECHARTS CIRCLE OF FIFTHS - PIE *** 
 // http://localhost:8082/music-staff.html
*/
...
const musicStaffOrderedFlatNotes = ['C', 'Db', 'D', 'Eb', 'E', 'F', 'Gb', 'G', 'Ab', 'A', 'Bb', 'B'];
...
for (let i=0; i<=8; i++) {
    ...
    const tempOctaveData = generateCircleNotes(musicStaffOrderedFlatNotes, i);
...
const majorOption = {
    ...
    xAxis: {
        ...
        data: musicStaffOrderedFlatNotes,
        position: 'top',
        splitArea: {
            show: false,
        },
